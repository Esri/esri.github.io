...
const getConfig = async () => {
    ...
    const fetchResult = await fetch(
      "https://cdn.jsdelivr.net/gh/esri/esri.github.io@v2/src/data/projects.yml"
    );
...
const getSection = (categoryConfig) => {
    ...
    // Create the title
    const title = createBasicDomNode(
      "h2",
      "text-xl font-bold mb-4 leading-4",
    ...
    const section = createBasicDomNode(
      "section",
      "flex flex-row space-x-4 mb-16",
      ""
    );
